...
const BlogPageComponent = () => {
        ...
        return (
                ...
                <BlogPageComponentNew
                    ...
                    headDescription={"123"}
                    headKeywords={"plener ślubny niepołomice, plener ślubny Zamek Króleski w Niepołomicach"}
                    ...
                    title={"PLENER ŚLUBNY ZAMEK KRÓLEWSKI W NIEPOŁOMICACH - BASIA i MARCIN"}
                    tags={"plener ślubny niepołomice, plener ślubny Zamek Króleski w Niepołomicach"}
                    date={"31 sierpnia 2020"}
                    menuNames={"BASIA i MARCIN"}
                    menuTitle={"PLENER ŚLUBNY ZAMEK KRÓLEWSKI W NIEPOŁOMICACH"}
