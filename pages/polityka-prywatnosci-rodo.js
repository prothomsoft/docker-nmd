...
const PageComponent = () => {
    ...
    const pageImage = process.env.staticS3ImagesPath + "plener-slubny-slowacja-lomnicki-staw-szczyrbskie-pleso-start-1.webp";
    ...
    <LayoutSitePage
      ...
      <Container sx={{ pt: 8, pb: 5 }}>
        ...
        <Typography variant="body1" align="justify" color="text.secondary" sx={{ pb: 2 }}>
          ...
          <Link href="mailto:tomasz@99foto.pl" target="_blank" rel="nofollow">
            tomasz@99foto.pl
          </Link>
